...
function Home() {
  ...
  return (
    <div>
        ...
        <div className="container-fluid d-flex">
          ...
          <div className="collapse navbar-collapse" id="navbarColor01">
            <div className="d-flex logout-button px-5">
              <button onClick={logout} className="btn btn-secondary my-2 my-sm-0" type="submit">
                Logout
              </button>
            </div>
          </div>
      ...
      <h2 className="text-primary font-weight-bold">Create a Recipe</h2>
      <form className="mb-5" onSubmit={createDish}>
